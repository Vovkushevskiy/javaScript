...
let getWeekDay = (d) => {
 ...
 console.log(getWeekDay('2019-02-30')); // среда
 console.log(getWeekDay('2019-07-16')); // вторник
 console.log(getWeekDay('2019-07-14')); // суббота
...
Car.prototype.info = function () {
 ...
 let car = new Car(2200, 'VectraC', 'Opel', 2004);
 let car2 = new Car(1600, 'Golf', 'Volkswagen', 2001);
